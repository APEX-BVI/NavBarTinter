...
public class BarTinter extends CordovaPlugin {
    ...
    private static final String PLUGIN = "BarTinter";
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if (colorPref != null && !colorPref.isEmpty()) {
                ...
                try {
                    ...
                    Log.w(PLUGIN, "Method window.setStatusBarColor not found for SDK level " + Build.VERSION.SDK_INT);
                }
            }
        }
    }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if (colorPref != null && !colorPref.isEmpty()) {
                ...
                try {
                    ...
                    Log.w(PLUGIN, "Method window.setNavigationBarColor not found for SDK level " + Build.VERSION.SDK_INT);
                }
            }
        }
    }
